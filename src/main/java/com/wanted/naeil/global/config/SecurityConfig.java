...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http,
        ...
        http.authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/auth/login", "/auth/signup", "/auth/fail", "/auth/find-id", "/auth/find-password",  "/", "/dashboard", "/dashboard/guest", "/course/**","/subscription/**",  "/community/**", "/error","/uploads/**").permitAll();
